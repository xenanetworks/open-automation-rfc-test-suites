...
from valhalla_core.test_suit_plugin.plugins.plugin2544.conversion.enums import (
    OSegmentType,
)
...
class Converter:
    ...
    def __gen_common_option(self, test_type_conf: Union["Throughput", "Latency", "Loss", "Back2Back"]) -> "CommonOptions":
