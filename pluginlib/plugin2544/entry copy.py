...
# # )
# # from .plugin.config_checkers import check_config
...
#         # self.control_ports: List["PortStruct"] = []
...
#         self.recources = ResourceManager(self.testers, list(self.cfg.ports_configuration.values()), self.port_identities)
...
#         await self.recources.init_resource(self.cfg.test_configuration)
